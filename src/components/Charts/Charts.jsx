...
const Charts = ({ isAllTime }) => {
  ...
  return (
    <div className={css.container}>
      ...
      <p className={css.maxW}>{params?.maxWeight} kg</p>
      <p className={css.minW}>{params?.minWeight} kg</p>
      <p className={css.maxK}>{params?.maxKcal} kcal</p>
      <p className={css.minK}>{params?.minKcal} kcal</p>
    </div>
  )
